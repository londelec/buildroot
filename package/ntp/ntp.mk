...
NTP_INSTALL_FILES_$(BR2_PACKAGE_NTP_NTPTRACE) += scripts/ntptrace/ntptrace scripts/calc_tickadj/calc_tickadj scripts/ntpsweep/ntpsweep scripts/update-leap/update-leap
